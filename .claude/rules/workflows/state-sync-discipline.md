...
- Los commands del `kit/` deben **recordar explícitamente** mantener el JSON up-to-date como
  parte de su definición (es un requisito de diseño de cada command, no un afterthought).
