...
document. The binary validates and persists it under the spec; the board's details drawer shows it
as a **download** in the *Files* section (open it at [excalidraw.com](https://excalidraw.com)).
...
![An Excalidraw wireframe generated by Vector for a product detail page: a desktop layout with a thumbnail rail, hero image, product name, price, color and size selectors, add-to-cart button, and detail tabs, beside a single-column mobile layout](docs/assets/sketch-example-pdp-editorial.png)
